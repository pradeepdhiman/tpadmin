...
export const tableheads = [
  ...
  { name: "qualificationName", label: "Qualification", align: 'left' },
  { name: "designationName", label: "Designation", align: 'left' },
  { name: "dob", label: "Date of Birth", align: 'left' },
  { name: "nationalityName", label: "Nationality", align: 'left' },
